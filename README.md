...
| [**PassWolf**](https://github.com/StrongWind1/PassWolf) | Spec-compliant AD password change, reset, and policy read over SAMR, Netlogon, LSA, Kerberos, LDAP | Python |
...
| [**WEPWolf**](https://github.com/StrongWind1/WEPWolf) | Offline, passive WEP key recovery from 802.11 captures | Rust |
